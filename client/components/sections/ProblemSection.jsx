  ...
  return (
    ...
    >
      ...
      <div className="relative flex flex-1 flex-col">
        <div className="flex h-12 w-12 items-center justify-center rounded-full border border-white/10 bg-white/5 text-[#94A3B8] shadow-[0_10px_26px_rgba(0,0,0,0.25)] transition-colors group-hover:text-[#26C1D3]">
          <Icon className="h-5 w-5" aria-hidden="true" />
        </div>

        <div className="mt-4 min-w-0">
          <div className="text-base font-semibold leading-snug text-[#E5E7EB]">
            {item.title}
          </div>
...
export default function ProblemSection() {
  ...
  return (
    <section className="tm-section tm-section--alt tm-section--image relative overflow-hidden border-t border-white/10 py-16 md:py-20">
